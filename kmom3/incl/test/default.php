...
<p>Här är en dynamisk sida, <code>test_minimal.php</code>, som underlättar att bygga upp samling 
med de testfall och exempel som kodas i de olika kursmomenten.</p>

<p>Källkoden för den dynamiska sidan, <code>test_minimal.php</code>, 
