...
<div id="content">
  ...
  <h3>Kursmoment:</h3>
    <ul>
      <li><a href=#kmom1>Kmom01: Kom igång med HTML, CSS och PHP</a></li>
      <li><a href=#kmom2>Kmom02: HTML-element och CSS-konstruktioner</a></li>
      <li><a href=#kmom3>Kmom03: Dynamisk webbplats med PHP</a></li>
      <li><a href=#kmom4>Kmom04: CSS och en style-väljare i PHP</a></li>
      <li><a href=#kmom5>Kmom05: HTML-formulär och PHP</a></li>
    </ul>
  </nav>
  ...
  <article>
    ...
    <section>
      ...
      <p>
         ...
         lite förvirrande och kännas överväldigande ibland då det börjar bli många filer nu. Jag hade lite problem
         med att få mina bilder att synas i Blokket, men det löste jag lätt genom att använda Firebug, jag kunde då se att
         sökvägen var fel. Jag hade också problem med att citattecken escape:ades varje gång en annons sparades, vilket
         gjorde att bildernas sökväg blev fel så att bilden inte visades. Detta problem uppstod dock endast lokalt och berodde
         på en inställning för magic quotes som saknades i min php.ini-fil.
      </p>
      <p>
         PHP programmeringen känns bra, även om jag inte
         känner att jag helt kommit in i det än. Mitt tips till andra är att kolla andras kod, göra tutorials och försöka göra
         likadant. Därför tycker jag det är ett bra upplägg på den här kursen. Det är förvisso lätt att kopiera mos kod, men
         ta dig ändå tid att testa och leka med den. Gör ändringar och se vad resultatet blir. Det har jag lärt mig mycket på.
      </p>
      <p>
